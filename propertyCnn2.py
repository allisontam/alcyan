    ...
    for epoch in range(num_epochs):
        ...
        for i, data in enumerate(trainloader, 0):
            ...
            if not i % 200:
                ...
                running_loss = 0.0
    torch.save(property_net.state_dict(), "models/propCnn2")
property_net.load_state_dict( torch.load('models/propCnn2') )
...
torch.save(property_net.pool_output, 'test_activations2.dat')
...
torch.save(property_net.pool_output, 'train_activations2.dat')
